  ...
  void _calculate() {
    setState(() {
      ...
      if (imc < 18.6) {
        ...
        _infoText =
            "Levemente acima do peso (${imc.toStringAsPrecision(3)}) $pesoAPerder";
      } else if (imc >= 29.9 && imc < 34.9) {
        _infoText =
            "Obesidade grau I (${imc.toStringAsPrecision(3)}) $pesoAPerder";
      } else if (imc >= 34.9 && imc < 39.9) {
        _infoText =
            "Obesidade grau II (${imc.toStringAsPrecision(3)}) $pesoAPerder";
      } else if (imc >= 40) {
        _infoText =
            "Obesidade grau III (${imc.toStringAsPrecision(3)} $pesoAPerder)";
      }
    });
  }
